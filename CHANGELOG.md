...
## [5.0.0](https://github.com/janklan/postgresql-for-doctrine/compare/v4.2.0...v5.0.0) (2026-02-11)


### ⚠ BREAKING CHANGES

* modernize with PHP 8.2 features (like read-only classes) ([#503](https://github.com/janklan/postgresql-for-doctrine/issues/503))
* drop support for PHP 8.1 ([#468](https://github.com/janklan/postgresql-for-doctrine/issues/468))
* remove deprecations scheduled for v4.0 ([#469](https://github.com/janklan/postgresql-for-doctrine/issues/469))
...
* **#305:** Add support for PostGIS measurement, overlay and geometry processing functions ([#435](https://github.com/janklan/postgresql-for-doctrine/issues/435)) ([9724452](https://github.com/janklan/postgresql-for-doctrine/commit/97244528f815f521d32e2c808f241245df67e139))
...
* **#410:**  add support for `LTREE` type ([#411](https://github.com/janklan/postgresql-for-doctrine/issues/411)) ([5a6563d](https://github.com/janklan/postgresql-for-doctrine/commit/5a6563d3431d7ea670407363527a645b3d25db32))
* **#440:** Add support for functions to use with the `LTREE` data type ([#440](https://github.com/janklan/postgresql-for-doctrine/issues/440)) ([745b269](https://github.com/janklan/postgresql-for-doctrine/commit/745b2695d334e8f352a6e24469ba2f39e175d1cb))
* **#456:** Add convenience factory methods to `WktSpatialData` ([#459](https://github.com/janklan/postgresql-for-doctrine/issues/459)) ([7242665](https://github.com/janklan/postgresql-for-doctrine/commit/7242665ff5cee24a80dddf85efe3b4a463ba3cbb))
* **#458:** Ensure Doctrine returns PostgreSQL spatial data in text format (EWKT) instead of binary format (EWKB) ([#462](https://github.com/janklan/postgresql-for-doctrine/issues/462)) ([8ac7a70](https://github.com/janklan/postgresql-for-doctrine/commit/8ac7a703c078a5845beee35e2f7f767cd563fbb4))
* **#510:** Add support for `UUID[]` data type ([#511](https://github.com/janklan/postgresql-for-doctrine/issues/511)) ([1c9cafb](https://github.com/janklan/postgresql-for-doctrine/commit/1c9cafb0a57c8fc3f7e1cf441de1908d032c8562))
* **#522:** Support bounded infinity values in range types ([#523](https://github.com/janklan/postgresql-for-doctrine/issues/523)) ([6e568d1](https://github.com/janklan/postgresql-for-doctrine/commit/6e568d1bed8b29ec552bf603c01eeb735ef6ecdf))
* **#538:** Add support for accessing field from a composite type ([#542](https://github.com/janklan/postgresql-for-doctrine/issues/542)) ([34bf515](https://github.com/janklan/postgresql-for-doctrine/commit/34bf515d4a58afaf0c14992b50c8ca4946c7b4da))
* **#538:** Add support for the functions provided by `fuzzystrmatch` extension ([#540](https://github.com/janklan/postgresql-for-doctrine/issues/540)) ([c8073c6](https://github.com/janklan/postgresql-for-doctrine/commit/c8073c6810f1b0796d28d47ae84b44c6838e716c))
...
* Add support for `AGE`, `DATE_PART`, `MAKE_DATE`, `MAKE_TIMESTAMP`, `MAKE_TIMESTAMPTZ`, `MAKE_TIME` ([#528](https://github.com/janklan/postgresql-for-doctrine/issues/528)) ([5e6956a](https://github.com/janklan/postgresql-for-doctrine/commit/5e6956ac5acdad1f7ed8870d5fecb5851c1bb868))
...
* Add support for `ARRAY_FILL`, `ARRAY_LOWER`, `ARRAY_SAMPLE`, `ARRAY_UPPER`, `JSONB_BUILD_ARRAY`, `JSON_BUILD_ARRAY` ([#530](https://github.com/janklan/postgresql-for-doctrine/issues/530)) ([a2091e8](https://github.com/janklan/postgresql-for-doctrine/commit/a2091e86c868bf1ac5ac477210db1eafa53bfe5d))
...
* Add support for `CONCAT_WS`, `FORMAT`, `LEFT`, `REPEAT`, `REVERSE`, `RIGHT` ([#533](https://github.com/janklan/postgresql-for-doctrine/issues/533)) ([83678f5](https://github.com/janklan/postgresql-for-doctrine/commit/83678f5276ea8a51eaaaaff7e31fed64ecaee870))
...
* Add support for `DATE_TRUNC` ([#493](https://github.com/janklan/postgresql-for-doctrine/issues/493)) ([01b564a](https://github.com/janklan/postgresql-for-doctrine/commit/01b564a3e6bd8b7c4a55c8c11a56c851e670c7b0))
...
* Add support for `JSONB_EXTRACT_PATH`, `JSON_EXTRACT_PATH`, `JSONB_EXTRACT_PATH_TEXT`, `JSON_EXTRACT_PATH_TEXT`, `JSONB_TO_TSVECTOR`, `JSONB_TYPEOF` ([#535](https://github.com/janklan/postgresql-for-doctrine/issues/535)) ([578e528](https://github.com/janklan/postgresql-for-doctrine/commit/578e5287fe060dc8d78104556be411bbe1d24f04))
* Add support for `JSONB_PATH_EXISTS()`, `JSONB_PATH_MATCH()`, `JSONB_PATH_QUERY()`, `JSONB_PATH_QUERY_ARRAY()` and `JSONB_PATH_QUERY_FIRST()` ([#346](https://github.com/janklan/postgresql-for-doctrine/issues/346)) ([0cda902](https://github.com/janklan/postgresql-for-doctrine/commit/0cda90218c4330b78c2a94f757e30e4045c70768))
...
* Add support for `ST_GeomFromGeoJSON` and `ST_AsGeoJSON` ([#545](https://github.com/janklan/postgresql-for-doctrine/issues/545)) ([e7f4df1](https://github.com/janklan/postgresql-for-doctrine/commit/e7f4df11b48f258595166b43e5621140460a037b))
* Add support for `uuid_extract_timestamp` and `uuid_extract_version` ([#466](https://github.com/janklan/postgresql-for-doctrine/issues/466)) ([77a513f](https://github.com/janklan/postgresql-for-doctrine/commit/77a513fe4472bbcc7c001bd25648384c48b39b16))
* Add support for `websearch_to_tsquery` ([#437](https://github.com/janklan/postgresql-for-doctrine/issues/437)) ([be90545](https://github.com/janklan/postgresql-for-doctrine/commit/be9054563fbdfda912256d4ff24d8d971eddc7ec))
...
* Add support for hashing and cryptographic functions `MD5`, `SHA224`, `SHA256`, `SHA384`, `SHA512` ([#507](https://github.com/janklan/postgresql-for-doctrine/issues/507)) ([3e42396](https://github.com/janklan/postgresql-for-doctrine/commit/3e42396f2dabf7b93cd912d2ade802d635b40c53))
...
* Add support for PostGIS functions `ST_ConcaveHull`, `ST_CurveN`, `ST_Letters`, `ST_NumCurves`, `ST_RemoveIrrelevantPointsForView`, `ST_RemoveSmallParts`, `ST_SimplifyPolygonHull`, `ST_TriangulatePolygon` ([#505](https://github.com/janklan/postgresql-for-doctrine/issues/505)) ([2992811](https://github.com/janklan/postgresql-for-doctrine/commit/299281132db21bb7ed1f564a13515525598866a7))
* Add support for PostGIS functions `ST_HasZ`, `ST_HasM`, `ST_CoverageUnion`, `ST_LineExtend` ([#504](https://github.com/janklan/postgresql-for-doctrine/issues/504)) ([826ffef](https://github.com/janklan/postgresql-for-doctrine/commit/826ffef1a9b62fff1bb7eea250b085a4711da551))
...
* Add support for some new functions from PostgreSQL 18 ([#464](https://github.com/janklan/postgresql-for-doctrine/issues/464)) ([118bfa3](https://github.com/janklan/postgresql-for-doctrine/commit/118bfa361ccbb776fe7832a05da357f5557568c5))
...
* Add the missing support for `null` values in the network array data types ([#517](https://github.com/janklan/postgresql-for-doctrine/issues/517)) ([7fb6dc7](https://github.com/janklan/postgresql-for-doctrine/commit/7fb6dc764391a708fca205755e79f2c827c2806f))
* Drop support for PHP 8.1 ([#468](https://github.com/janklan/postgresql-for-doctrine/issues/468)) ([94f2ed8](https://github.com/janklan/postgresql-for-doctrine/commit/94f2ed83ee9f44d76c0937cbe9494f267ade3efe))
...
* Improve accidental misconfiguration through the use of constants for all DBAL types ([#486](https://github.com/janklan/postgresql-for-doctrine/issues/486)) ([2fcdf95](https://github.com/janklan/postgresql-for-doctrine/commit/2fcdf95dee307319655acbec7f43e4c59c7e19d8))
* Modernize with PHP 8.2 features (like read-only classes) ([#503](https://github.com/janklan/postgresql-for-doctrine/issues/503)) ([20b29b1](https://github.com/janklan/postgresql-for-doctrine/commit/20b29b101e3adf0bac6a9ac9f58e529f9e905068))
...
* Remove deprecations scheduled for v4.0 ([#469](https://github.com/janklan/postgresql-for-doctrine/issues/469)) ([73585aa](https://github.com/janklan/postgresql-for-doctrine/commit/73585aa299e528450c8159517f0819dba6806319))
* Support binding input arguments to several PostGIS functions ([#543](https://github.com/janklan/postgresql-for-doctrine/issues/543)) ([161f74b](https://github.com/janklan/postgresql-for-doctrine/commit/161f74bca557d8f5178a313b3b30208272bfeea1))
...
* **#424:** Address unintentional loss of string data type when retrieving PHP array item values from a stored `TextArray` value ([#443](https://github.com/janklan/postgresql-for-doctrine/issues/443)) ([bdb8df2](https://github.com/janklan/postgresql-for-doctrine/commit/bdb8df28f173d0e5b8510fa33c529af42fc01660))
* **#446:** Restore `OVERLAPS` to its intended namespace and strengthen its test coverage ([#447](https://github.com/janklan/postgresql-for-doctrine/issues/447)) ([6435f06](https://github.com/janklan/postgresql-for-doctrine/commit/6435f0673250bd9e4f65b8918ff000c7b21b788a))
* **#473:** Add public getter methods to `Range` value objects ([#477](https://github.com/janklan/postgresql-for-doctrine/issues/477)) ([9ba319e](https://github.com/janklan/postgresql-for-doctrine/commit/9ba319ea1d4cfeea48dfa6ab44d1820f51c689a9))
* **#474:** Support usage of arithmetic expressions in mathematical functions ([#475](https://github.com/janklan/postgresql-for-doctrine/issues/475)) ([75b025d](https://github.com/janklan/postgresql-for-doctrine/commit/75b025d636b52621b4be47bd94ea1f163017450e))
* **#482:** Always preserve strings (even if they are obviously numerical) when transforming a `TEXTARRAY` value into a PHP array ([#488](https://github.com/janklan/postgresql-for-doctrine/issues/488)) ([77eed3e](https://github.com/janklan/postgresql-for-doctrine/commit/77eed3eea3266b5f6b436f4bf624246299527d61))
...
* Address broken escaping of array items for `JsonbArray` and preserve integer values as strings if they are outside PHP integer range ([#442](https://github.com/janklan/postgresql-for-doctrine/issues/442)) ([d213967](https://github.com/janklan/postgresql-for-doctrine/commit/d2139679a6b193df3e45ce04c8e56ebbc9dcf6f2))
...
* Add support for `AGE`, `DATE_PART`, `MAKE_DATE`, `MAKE_TIMESTAMP`, `MAKE_TIMESTAMPTZ`, `MAKE_TIME` ([#528](https://github.com/martin-georgiev/postgresql-for-doctrine/issues/528)) ([5e6956a](https://github.com/martin-georgiev/postgresql-for-doctrine/commit/5e6956ac5acdad1f7ed8870d5fecb5851c1bb868))
* Add support for `ARRAY_FILL`, `ARRAY_LOWER`, `ARRAY_SAMPLE`, `ARRAY_UPPER`, `JSONB_BUILD_ARRAY`, `JSON_BUILD_ARRAY` ([#530](https://github.com/martin-georgiev/postgresql-for-doctrine/issues/530)) ([a2091e8](https://github.com/martin-georgiev/postgresql-for-doctrine/commit/a2091e86c868bf1ac5ac477210db1eafa53bfe5d))
* Add support for `CONCAT_WS`, `FORMAT`, `LEFT`, `REPEAT`, `REVERSE`, `RIGHT` ([#533](https://github.com/martin-georgiev/postgresql-for-doctrine/issues/533)) ([83678f5](https://github.com/martin-georgiev/postgresql-for-doctrine/commit/83678f5276ea8a51eaaaaff7e31fed64ecaee870))
* Add support for `JSONB_EXTRACT_PATH`, `JSON_EXTRACT_PATH`, `JSONB_EXTRACT_PATH_TEXT`, `JSON_EXTRACT_PATH_TEXT`, `JSONB_TO_TSVECTOR`, `JSONB_TYPEOF` ([#535](https://github.com/martin-georgiev/postgresql-for-doctrine/issues/535)) ([578e528](https://github.com/martin-georgiev/postgresql-for-doctrine/commit/578e5287fe060dc8d78104556be411bbe1d24f04))
